...
sequences_df = pd.read_csv('/group/bioinf_protstr/Ballal/Research_Project/ballal_research_project/fetched_sequences/cath_non_redundant_pdbs_s20_sequence_reduced_ForkPoolWorker-1.csv')
## id,AA_seq,SS_seq
...
#align_args = [(qr_str, qr_id,sequences_df.copy()) for qr_str, qr_id in zip(sequences_df.sequence, sequences_df.domain_id)]
align_args = [(qr_str,qr_id,sequences_df.copy()) for qr_str, qr_id in zip(sequences_df.SS_seq, sequences_df.id)]
