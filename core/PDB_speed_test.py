...
if __name__ == "__main__":
    ...
    df = pd.read_csv("cath-selection_random_1000_speed_test.csv")
    ...
    with open("cath_all_proteins_dictionary_with_BM_speed_test.pickle", "wb") as handle:
